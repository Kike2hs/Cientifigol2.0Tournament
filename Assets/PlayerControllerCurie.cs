...
public class PlayerControllerCurie : MonoBehaviour
{
    ...
    // No necesitamos la detección del botón para activar la habilidad especial
    // Ya que no estamos utilizando un botón en este caso.
